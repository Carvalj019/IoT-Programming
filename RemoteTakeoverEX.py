...
if __name__ == '__main__':
    ...
    #make additional variables for each characteristic you'd like to keep track of
    ...
    #This is a simple subscript that will generate a strobe light effect
    ...
    #We are able to remotely control these bulbs due to a lack of encryption and secure connection protocols.